...
// Include the necessary types and function declarations from the main file
// (We'll copy the essential definitions needed for our tests)

// Define the minimal types and functions we need to test
...
// Test MD5 function with a known value
void test_md5(void) {
    unsigned char data[] = "abc";
    unsigned char hash[16];
    unsigned char expected[] = {0x90, 0x01, 0x50, 0x98, 0x3c, 0xd2, 0x4f, 0xb0, 
                                0xd6, 0x96, 0x3f, 0x7d, 0x28, 0x8a, 0x9d, 0xc2};
    
    calculate_md5(data, 3, hash);
    ...
    TEST_ASSERT(matches, "MD5 hash of 'abc' should match expected value");
}

// Test SHA256 function with a known value
void test_sha256(void) {
    unsigned char data[] = "abc";
    unsigned char hash[32];
    // Expected SHA256 hash of "abc"
    unsigned char expected[] = {0xba, 0x78, 0x16, 0xbf, 0x8f, 0x01, 0xcf, 0xea, 
                                0x41, 0x41, 0x40, 0xde, 0x5d, 0xae, 0x22, 0x23,
                                0xb0, 0x03, 0x61, 0xa3, 0x96, 0x17, 0x7a, 0x9c,
                                0xb4, 0x10, 0xff, 0x61, 0xf2, 0x00, 0x15, 0xad};
    
    calculate_sha256(data, 3, hash);
    ...
    TEST_ASSERT(matches, "SHA256 hash of 'abc' should match expected value");
}
